                ...
                <ul className="learning__box">
                    <li className="learning__item">
                        <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="learning__item-link"><img src={practicum} className="learning__item-img" alt="project" /></a>
                        <div className="learning__item-textbox">
                            <h3 className="learning__item-title lobster">I learned from Practicum by Yandex.</h3>
                            <p>In 2020, I was fortunately selected to be part of practicum by yandex beta-test program-a intensive 10-month course in web development that covers HTML, CSS, JavaScript, React, back-end infrastructure, and more. Throughout the curriculum, I developed essential soft skills by working projects with hard deadlines. I am now working at the final project and will finished the program at the end of December.</p>
                    ...
                    <li className="learning__item">
                        <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="learning__item-link"><img src={cousera} className="learning__item-img" alt="project" /></a>
                        <div className="learning__item-textbox">
                    ...
                    <li className="learning__item">
                        <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="learning__item-link"><img src={edx} className="learning__item-img" alt="project" /></a>
                        <div className="learning__item-textbox">
                            <h3 className="learning__item-title lobster">I learned from Edx.</h3>
                            <p>I audited the famous <a
                                href="https://cs50.harvard.edu/college/2020/fall/"
                                target="_blank"
                                rel="noreferrer"
                                className="learning__item-link">CS50 course</a> offered by Harvard University from Edx. It was a mind browing experience. I learned fundamental knowledge of computer science with a big picture in such a short time and all the coding and programming suddenly made more sense to me. I finished most of <a
                                    href="https://github.com/iceicery/HarvardX----CS50"
                                    target="_blank"
                                    rel="noreferrer"
                                    className="learning__item-link">the assignments</a> and I enjoyed the challenge of each of them. </p>
                    ...
                    <li className="learning__item">
                        <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="learning__item-link"><img src={codewar} className="learning__item-img" alt="project" /></a>
                        <div className="learning__item-textbox">
