...
import emoji from '../../images/avatarAmy.png';
function Menu() {
  return (
    <header className="menu">
      <div className="menu__img-box">
        <img src={developer} alt="develope" className="menu__develope" />
      </div>
      <div className="menu__text-box">
        ...
        <menu className="menu__list-box">
          <Link to="/projects" className="menu__list">
            Web Projects
          </Link>
          <Link to="/learning" className="menu__list">
            Learning Track
          </Link>
          <Link to="/before" className="menu__list">
            Before Coding
          </Link>
          {/*
